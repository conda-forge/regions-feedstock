...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/regions-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/regions-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/regions-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/regions-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/regions-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/regions-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/regions/badges/version.svg)](https://anaconda.org/conda-forge/regions)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/regions/badges/downloads.svg)](https://anaconda.org/conda-forge/regions)
